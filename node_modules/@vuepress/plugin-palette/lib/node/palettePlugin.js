...
const palettePlugin = ({ preset = 'css', userPaletteFile = presetOptions_1.presetOptions[preset].userPaletteFile, tempPaletteFile = presetOptions_1.presetOptions[preset].tempPaletteFile, userStyleFile = presetOptions_1.presetOptions[preset].userStyleFile, tempStyleFile = presetOptions_1.presetOptions[preset].tempStyleFile, importCode = presetOptions_1.presetOptions[preset].importCode, }, app) => ({
