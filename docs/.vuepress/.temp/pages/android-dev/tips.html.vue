...
<div class="language-kotlin ext-kt line-numbers-mode"><pre v-pre class="language-kotlin"><code><span class="token keyword">suspend</span> <span class="token keyword">fun</span> <span class="token function">call</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=</span> suspendCoroutine<span class="token operator">&lt;</span>T<span class="token operator">></span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><h2 id="ignore-deprecation" tabindex="-1"><a class="header-anchor" href="#ignore-deprecation" aria-hidden="true">#</a> ignore DEPRECATION</h2>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>@Suppress("DEPRECATION")
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><h2 id="导航栏背景全透明前景色不为全白的方法-transparent-navigationbar" tabindex="-1"><a class="header-anchor" href="#导航栏背景全透明前景色不为全白的方法-transparent-navigationbar" aria-hidden="true">#</a> 导航栏背景全透明前景色不为全白的方法 Transparent NavigationBar</h2>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>在给定 Activity 添加以下代码。</p>
